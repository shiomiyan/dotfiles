...
ln -s ~/dotfiles/config/obsidian/share/applications/obsidian.desktop ~/.local/share/applications/obsidian.desktop
ln -s ~/dotfiles/config/obsidian/share/icons/obsidian.png ~/.local/share/icons/obsidian.png
